...
class HrFamilyInfo(models.Model):
    ...
    certificate = fields.Selection(CERTIFICATE_SELECTION, 'Certificate Level', default='other', groups="hr.group_hr_user")
    certificate_id = fields.Many2one('emp.certificate')
