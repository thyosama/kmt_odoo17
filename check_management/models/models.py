...
class Journal (models.Model):
    ...
    is_treasury_feed = fields.Boolean(string='Treasury Feed')
    is_account_feed = fields.Boolean(string='Account Feed')
    treasury_feed_account_id = fields.Many2one('account.account', string="Treasury Feed Account")
    account_feed_account_id = fields.Many2one('account.account', string="Account Feed Account")